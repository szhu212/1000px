...
p = Hash.new()
p[0] = Picture.create!(title:"Attack on Titan - Levi", description:"Digital painting of Levi from Attach on Titan", author_id:user[0].id, equipment_or_material:"Wacom Intuo 4 Tablet", editors_choice:"true")
...
p[5] = Picture.create!(title:"Japan Impression", description:"I have my stars in the sky, but oh for my little lamp unlit in my house.",author_id:user[5].id, equipment_or_material:"Watercolor", editors_choice:"true")
...
p[46] = Picture.create!(title:"Group portrait", description:"Characters from Jojo's Bizarre Advanture.",author_id:user[3].id, equipment_or_material:"Wacom Intuos Tablet", editors_choice:"false")
p[47] = Picture.create!(title:"Man in the sky", description:"Poster for a dear friend's new book.",author_id:user[7].id, equipment_or_material:"Wacom Bamboo Tablet", editors_choice:"false")
